...
lines_object::lines_object(const vertices_t& vertices, Eigen::Vector4f color, float line_width, mode_t mode, bool casts_shadows) : renderable(casts_shadows), vertices_(vertices), line_width_(line_width), mode_(mode) {
    colors_t colors(vertices.size(), color);
